...
<a href="https://dashboard.heroku.com/new?template=https://github.com/uncix/YukkiMusicBot"><img src="https://img.shields.io/badge/Deploy%20To%20Heroku-blueviolet?style=for-the-badge&logo=heroku" width="200""/></a>
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/uncix/YukkiMusicBot && cd YukkiMusicBot
   ```
